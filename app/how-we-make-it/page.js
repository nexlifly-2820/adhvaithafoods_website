...
const steps = [
  ...
  { num: '05', title: 'Mixing', subtitle: 'The secret moment', desc: 'Sun-dried ingredients meet stone-ground spices and cold-pressed sesame oil in large clay or stainless steel vessels. The mixing is done by hand with food-grade gloves — you can feel the oil coat every piece evenly. The mixture then rests for 24–48 hours, allowing flavors to deepen and meld.', detail: 'Cold-pressed sesame oil · Hand-mixed', emoji: '🫙', color: '#2D5A27', id: 'step-mixing', img: 'https://images.unsplash.com/photo-1627464983056-11f8e13d5cf5?q=80&w=1600&auto=format&fit=crop' },
  { num: '06', title: 'Hand-Packing', subtitle: 'Sealed with love', desc: 'Pickles are hand-packed into clean, sterilized glass jars. Each jar is filled to exact weight, checked for air pockets, and sealed with a fresh lid. A kraft label is tied by hand. Then each jar undergoes a final quality check — taste, color, oil level, aroma — before it\'s approved to ship.', detail: 'Sterilized glass jars · Handcrafted labels', emoji: '📦', color: '#C4603A', id: 'step-packing', img: 'https://images.unsplash.com/photo-1589255474136-22a00cb0b230?q=80&w=1600&auto=format&fit=crop' },
];
      ...
      <main>
        ...
        <section id="process-hero" style={{
          ...
          <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
             <img src="https://images.unsplash.com/photo-1615486171448-4ffdc9481977?q=80&w=2000&auto=format&fit=crop" alt="Spices background" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
             <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, rgba(26,10,3,0.7), rgba(26,10,3,0.95))' }} />
          </div>
